...
# 主页
s.homepage = "https://github.com/tospery/TYAlertController-JX"
...
s.source = { :git => "https://github.com/tospery/TYAlertController-JX.git", :tag => s.version.to_s }
# 如果使用pod 需要导入哪些资源
